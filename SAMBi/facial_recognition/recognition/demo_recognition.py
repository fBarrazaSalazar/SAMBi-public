...
if __name__ == '__main__':
    ...
    detector = YuNet(modelPath='../detection/face_detection_yunet_2022mar.onnx',
                     inputSize=[320, 320],
                     confThreshold=0.9,
                     nmsThreshold=0.3,
                     topK=5000,
    ...
    img1 = cv.imread("D:\\Proyectos\\SAMBi\\opencv_facialrecognition\\dataset\\train\\Kim Wexler\\12729228_440501909492425_3663237696211661730_n.jpg")
    img2 = cv.imread("D:\\Proyectos\\SAMBi\\opencv_facialrecognition\\dataset\\test\\FPLPMVVDGFB3PNJEXPKVGYKKRQ.webp")
